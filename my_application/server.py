...
def queues_index():
	...
	curl -s -X GET -H 'Accept: application /json' http://localhost:8080/queues | python -mjson.tool
 	curl -s -X GET -H 'Accept: application /json' 83.212.127.232:8080/queues | python -mjson.tool
	"""
	all = []
	conn = get_conn()
...
def queues_create():
	...
	curl -X POST -H 'Content-Type: application/json' http://localhost:8080/queues -d '{"name": "C13470112"}'
	curl -X POST -H 'Content-Type: application/json' 83.212.127.232:8080/queues -d '{"name": "C13470112"}'	
...
def queues_remove(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:8080/queues/C13470112
	curl -X DELETE -H 'Accept: application/json' 83.212.127.232:8080/queues/C13470112
...
def messages_write(name):
	...
	curl -s -X POST -H 'Accept: application/json' http://localhost:8080/queues/C13470112/msgs -d '{"content": "this is the message I want to put on the queue"}' 
	curl -s -X POST -H 'Accept: application/json' 83.212.127.232:8080/queues/C13470112/msgs -d '{"content": "this is the message I want to put on the queue"}'
	"""
...
def messages_read(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:8080/queues/C13470112/msgs
	curl -X GET -H 'Accept: application/json' 83.212.127.232:8080/queues/C13470112/msgs
	"""
...
def messages_consume(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:8080/queues/C13470112/msgs
	curl -X DELETE -H 'Accept: application/json' 83.212.127.232:8080/queues/C13470112/msgs
	"""
